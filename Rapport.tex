...
\end{align*}
We use an algorithme that doesn't need the explicit expression of the gradient, since we were not able, to calculate the gradient of the constraint. We set the default parameters of the \texttt{nlopt} function.
